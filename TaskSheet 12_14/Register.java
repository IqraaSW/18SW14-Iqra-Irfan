...
//        JDialog d=new JDialog(this,"Dialog");
    ...
    @Override
         ...
         String [] s={"Name = "+ nameT.getText(),"Father Name = " +fatherT.getText(),"Gender = "+ genderBox.getSelectedItem().toString(),"Password = " +new String(CpasswordT.getPassword())  ,"City = "+cityT.getText(),"Email = "+emailT.getText()};                     JOptionPane.showConfirmDialog(this,s, "Confirmation Message",JOptionPane.PLAIN_MESSAGE);
         }
